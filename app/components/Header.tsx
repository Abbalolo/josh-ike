...
function Header() {
  ...
  return (
    <header
      className={`w-full flex  items-center justify-between px-10 py-3 fixed left-0 top-0 z-50  dark:text-[#ffffff] ${
    ...
    >
      ...
      >
        ...
        <button
          ...
          className="md:ml-5 h-10 w-10 rounded-lg p-2 hover:bg-gray-100 bg-white dark:bg-black dark:hover:bg-gray-700 transition-all duration-300 absolute md:static top-5 left-5"
        >
          <svg
